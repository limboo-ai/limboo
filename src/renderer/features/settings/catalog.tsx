...
export const SETTINGS_CATALOG: SettingsCategory[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'runtimeRingMetric', label: 'Ring measures', keywords: ['runtime', 'ring', 'context', 'remaining', 'quota', 'metric'] },
      ...
      { id: 'runtimeShowCost', label: 'Show estimated cost', keywords: ['runtime', 'cost', 'usd', 'estimate', 'price', 'spend'] },
      ...
      { id: 'runtimeWarnQuota', label: 'Quota warning threshold', keywords: ['runtime', 'quota', 'limit', 'warn', 'rate limit'] },
      ...
      { id: 'runtimeShowHistory', label: 'Show usage history', keywords: ['runtime', 'history', 'trend', 'graph', 'usage'] },
      ...
      { id: 'runtimeSectionOrder', label: 'Inspector section order', keywords: ['runtime', 'order', 'sections', 'reorder', 'inspector'] },
