 ...
 *
 * Git shows unpushed commits ahead; Memory shows pending proposals; Hooks shows
 * denied tool gates on the active session — each a subtle accent dot with a count.
 */
